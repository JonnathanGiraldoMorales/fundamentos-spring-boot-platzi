...
@RestController
@RequestMapping("/api/users")//Ruta donde va a ser consumido este servicio
public class UserRestController {
    ...
    @GetMapping("/") //Por donde va a ser consumido a nivel de http, es como la sub ruta dentro de la ruta requestMapping
    List<User> get(){
